<template>
    ...
    <v-layout>
                    ...
                    <ModelClientHotel ref="ModelClientHotel" />
                                ...
                                <v-layout row wrap>
                                  ...
                                  <v-flex xs12 sm12 md6 lg6>
                                    ...
                                    <v-flex xs12 sm12 md12 lg12>
                                        <div class="mr-1">
                                            <v-autocomplete label="Selectionnez la Catgorie" prepend-inner-icon="mdi-map"
                                    ...
                                    <v-flex xs12 sm12 md6 lg6>
                                        <div class="mr-1">
                                            <v-autocomplete label="Selectionnez l'Appartement" prepend-inner-icon="mdi-map"
                                    ...
                                    <v-flex xs12 sm12 md6 lg6>
                                        <div class="mr-1">
                                            <v-text-field type="number" readonly label="Prix Appartement($)" prepend-inner-icon="event" dense
                                ...
                                <template v-slot:default>
                                  <thead>
                                    <tr>
                                      ...
                                      <th class="text-left">Appartement</th>
                                      ...
                                      <th class="text-left">NombreMois</th>
        ...
        import ModelClientHotel from './ModelClientHotel.vue';
        ...
        export default {
          ...
          methods: {
            ...
            validate() {
              if (this.$refs.form.validate()) {
                ...
                if (this.edit) {
                  ...
                  this.svData.libelle="Reservation Appartement";
                  this.svData.type_reservation = "Mensuel";
                  this.svData.pays_provenance = "RDC";
                  this.svData.reduction=0;
                  this.svData.devise="USD";
                  this.svData.observation="Location Appartement";
                  this.svData.nom_accompagner="RAS"

                  this.insertOrUpdate(
                    `${this.apiBaseURL}/update_hotel_reservation_appartement/${this.svData.id}`,
                  ...
                  this.insertOrUpdate(
                    `${this.apiBaseURL}/insert_hotel_reservation_appartement`,
                    JSON.stringify(this.svData)
                  )
                    .then(({ data }) => {
                      this.showMsg(data.data);
            ...
            editData(id) {
              this.editOrFetch(`${this.apiBaseURL}/fetch_single_hotel_reservation_appartement/${id}`).then(
                ({ data }) => {
                  var donnees = data.data;
                donnees.map((item) => {
            ...
            deleteData(id) {
              this.confirmMsg().then(({ res }) => {
                this.delGlobal(`${this.apiBaseURL}/delete_hotel_reservation_appartement/${id}`).then(
                  ({ data }) => {
                    this.showMsg(data.data);
                    this.fetchDataList();
                  }
            ...
            printBill(id) {
              window.open(`${this.apiBaseURL}/pdf_facture_appartement?id=` + id);
            },
            ...
            fetchDataList() {
              this.fetch_data(`${this.apiBaseURL}/fetch_hotel_reservation_appartement?page=`);
            },
        
            fetchListChambre() {
              this.editOrFetch(`${this.apiBaseURL}/chambre_by_categorie/${this.svData.refClasse}`).then(
                ({ data }) => {
                  var donnees = data.data;
    ...
    //
        ...
        showFacture(refEnteteVente, name,ServiceData) {
          ...
          if (refEnteteVente != '') {
            ...
            showClientHotel() {
            this.$refs.ModelClientHotel.$data.etatModal = true;
            this.$refs.ModelClientHotel.testTitle();
            this.$refs.ModelClientHotel.onPageChange();
            this.$refs.ModelClientHotel.fetchListCompte();
            this.fetchListClient();
    
            this.$refs.ModelClientHotel.$data.titleComponentss =
                "Un nouveau Client";
