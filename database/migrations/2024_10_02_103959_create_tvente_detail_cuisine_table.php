...
class CreateTventeDetailCuisineTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tvente_detail_cuisine', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tvente_detail_cuisine');
    }
}
