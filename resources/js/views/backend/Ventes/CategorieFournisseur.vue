                  ...
                  <v-flex xs12 sm12 md12 lg12>
                    <div class="mr-1">
                      <v-text-field label="Designation" prepend-inner-icon="extension" dense
                        ...
                        v-model="svData.nom_categoriefss"></v-text-field>
                    </div>
                  </v-flex>
                  <v-flex xs12 sm12 md12 lg12>
                    <div class="mr-1">
                  ...
                  <v-flex xs12 sm12 md12 lg12>
                    <div class="mr-1">
                      <v-autocomplete label="Selectionnez le Sous Sous-Compte" prepend-inner-icon="map"
                        ...
                        item-text="nom_ssouscompte" item-value="id" dense outlined v-model="svData.compte_fss_bl"
                        clearable chips>
                      </v-autocomplete>
                    </div>
                  </v-flex>
                        ...
                        <div class="mr-1">
                          <v-autocomplete label="Activé" :items="[
                            ...
                            { designation: 'NON' },                                       
                              ...
                              v-model="svData.active"></v-autocomplete>
                        </div>
                    </v-flex>
...
export default {
  ...
  methods: {
    ...
    showModal() {
      this.dialog = true;
      this.titleComponent = "Ajout Catégorie Fournisseur ";
      this.edit = false;
    ...
    testTitle() {
      if (this.edit == true) {
        this.titleComponent = "modification de " + item.nom_categoriefss;
      } else {
    ...
    //   }, 300),
    onPageChange() {
      this.fetch_data(`${this.apiBaseURL}/fetch_vente_categoriefss?page=`);
    },
    ...
    validate() {
      if (this.$refs.form.validate()) {
        ...
        this.insertOrUpdate(
          `${this.apiBaseURL}/insert_vente_categoriefss`,
    ...
    editData(id) {
      this.editOrFetch(`${this.apiBaseURL}/fetch_single_vente_categoriefss/${id}`).then(
        ({ data }) => {
    ...
    clearP(id) {
      this.confirmMsg().then(({ res }) => {
        this.delGlobal(`${this.apiBaseURL}/delete_vente_categoriefss/${id}`).then(
          ({ data }) => {
