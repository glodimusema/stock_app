<template>
                ...
                <v-dialog v-model="dialog" max-width="400px" persistent>
                  <v-card :loading="loading">
                    <v-form ref="form" lazy-validation>
                      <v-card-title>
                        Details Entree <v-spacer></v-spacer>
  ...
  export default {
    ...
    methods: {
      ...
      fetchDataList() {
        this.fetch_data(`${this.apiBaseURL}/fetch_vente_detail_entree_byentete/${this.refEnteteEntree}?page=`);
      },  
      fetchListTVA() {
        ...
        async updateUnite() {
                try {
                    ...
                    if (donnees.length > 0) {
                        ...
                        this.svData.puEntree = donnees[0].cmup; // Update price per unit                        
                    } else {
