...
class CreateTventeDetailUtilisationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tvente_detail_utilisation', function (Blueprint $table) {
            $table->id();
            $table->foreignId('refEnteteVente')->constrained('tvente_entete_utilisation')->restrictOnUpdate()->restrictOnDelete();
    ...
    {
        Schema::dropIfExists('tvente_detail_utilisation');
    }
}
