<template>
                  ...
                  <v-dialog v-model="dialog" max-width="400px" persistent>
                    <v-card :loading="loading">
                      <v-form ref="form" lazy-validation>
                        ...
                        <v-autocomplete label="Selectionnez le Lot(Kit)" prepend-inner-icon="mdi-map"
    ...
    export default {
      ...
      methods: {
        ...
        fetchDataList() {
          this.fetch_data(`${this.apiBaseURL}/fetch_gaz_service_stock_byservice/${this.refService}?page=`);
        },
