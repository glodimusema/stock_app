<template>
                      ...
                      <v-form ref="form" lazy-validation>
                        ...
                        <v-card-text>
                          ...
                          <v-autocomplete label="Selectionnez l'Unité" prepend-inner-icon="mdi-map"
                            ...
                            @change="getPrice(svData.refDetailUnite)">
                          </v-autocomplete>
    ...
    export default {
      ...
      created() {         
        ...
        // this.get_unite_for_produit(idProduit)"
      },
      computed: {
      ...
      methods: {
        ...
        fetchDataList() {
          this.fetch_data(`${this.apiBaseURL}/fetch_vente_service_stock_byproduct/${this.refProduit}?page=`);
        },
