                    ...
                    <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-autocomplete label="Selectionnez le Service" prepend-inner-icon="mdi-map"
                                ...
                                clearable @change="fetchListDataProduit(svData.refService)">
                            </v-autocomplete>
                        </div>
                    </v-flex>
                    <v-flex xs12 sm12 md6 lg6>
                    ...
                    <v-flex xs12 sm12 md6 lg6>
                        <div class="mr-1">
                            <v-select label="Selectionnez la Catégorie" prepend-inner-icon="mdi-map" dense
                                ...
                                item-text="designation" item-value="id" outlined v-model="svData.refCategorie">
                            </v-select>
                        </div>
                    </v-flex>
                    <!-- <v-flex xs12 sm12 md6 lg6>
    ...
    methods: {
        ...
        async fetchListDataProduit(code) {
            try {
                ...
                const response = await this.editOrFetch(`${this.apiBaseURL}/fetch_stock_fiche_byservice/${code}`);
                const { data } = response;
                ...
                if (data && data) {
                    ...
                    this.svData.detailData = donnees.map((item, index) => {
                        ...
                        return {
                            ...
                            qteDisponible: item.SF,
                            qteVente: item.SF,
                            puVente: item.PU,
                            idStockService: item.id,
                            nom_unite: item.Unite
