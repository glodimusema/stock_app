    ...
    methods: {
        ...
        async updateUnite(index) { 
                try {
                    ...
                    const response = await this.editOrFetch(`${this.apiBaseURL}/fetch_gaz_service_stock_byservice/${this.svData.detailData[index].idStockService}`);
            ...
            try
            {
                ...
                if (this.$refs.form.validate()) {
                    ...
                    this.svData.author = this.userData.name;
                        ...
                        this.insertOrUpdate(
                        `${this.apiBaseURL}/insert_gaz_globale_utilisation`,
