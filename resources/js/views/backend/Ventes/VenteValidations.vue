<template>
                      ...
                      <v-form ref="form" lazy-validation>
                        ...
                        <v-card-text>
                          ...
                          <v-layout row wrap>
                            ...
                            <v-flex xs12 sm12 md12 lg12>
                              <div class="mr-1">
                                <v-text-field label="Code Opération" prepend-inner-icon="event" dense
                                  outlined v-model="svData.codeOperation">
                                </v-text-field>
                              </div>
                            </v-flex>                          
    ...
    export default {
      ...
      methods: {
        ...
        validate() {
          if (this.$refs.form.validate()) {
            ...
            if (this.edit) {
              ...
              this.insertOrUpdate(
                `${this.apiBaseURL}/update_vente_validation/${this.svData.id}`,
              ...
              this.svData.refUser = this.userData.id;
              this.insertOrUpdate(
                `${this.apiBaseURL}/insert_vente_validation`,
                JSON.stringify(this.svData)
              )
                .then(({ data }) => {
                  this.showMsg(data.data);
        ...
        // s'id','user_id','module_id','puUnite','qteUnite','author'
        //   this.fetchDataList();
        // }, 300),
    
        editData(id) {
          this.editOrFetch(`${this.apiBaseURL}/fetch_single_vente_validation/${id}`).then(
            ({ data }) => {
        ...
        deleteData(id) {
          this.confirmMsg().then(({ res }) => {
            this.delGlobal(`${this.apiBaseURL}/delete_vente_validation/${id}`).then(
              ({ data }) => {
                this.showMsg(data.data);
                this.fetchDataList();
              }
        ...
        fetchDataList() {
          this.fetch_data(`${this.apiBaseURL}/fetch_vente_validationEntete/${this.user_id}?page=`);
        },
