...
class CreateTgazEnteteUtilisationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tgaz_entete_utilisation', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tgaz_entete_utilisation');
    }
}
