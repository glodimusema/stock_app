  ...
  export default {
    ...
    methods: {
      ...
      updatePhoto() {
        ...
        if (this.edit == true) {
          this.svData.refCommande = this.refCommande;
          this.svData.author = this.userData.name;
          axios
            .post(`${this.apiBaseURL}/update_annexe_commande`, formData, config)
            .then(({ data }) => {
              this.image = "";
          ...
          this.svData.author = this.userData.name;
          axios
            .post(`${this.apiBaseURL}/insert_annexe_commande`, formData, config)
            .then(({ data }) => {
              this.image = "";
              this.showMsg(data.data);
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_annexe_commande/${id}`).then(
          ({ data }) => {
            var donnees = data.data;
            donnees.map((item) => {
              this.svData.id = item.id;
              this.svData.refCommande = item.refCommande;
      ...
      deleteData(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_annexe_commande/${id}`).then(
            ({ data }) => {
              this.showMsg(data.data);
              this.fetchDataList();
            }
      ...
      fetchDataList() {
        this.fetch_data(`${this.apiBaseURL}/fetch_annexe_bycommande/${this.refCommande}?page=`);
        //
      },
