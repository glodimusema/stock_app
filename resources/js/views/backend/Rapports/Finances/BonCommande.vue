<template>
              ...
              <div>
                ...
                <tr style="vertical-align:top;">
                  ...
                  <td class="csAA7EBA13" colspan="10"
                    ...
                    <nobr>00{{ entete.refEnteteCmd }}</nobr>
                  </td>
                  <td></td>
                  <td></td>
                </tr>
                ...
                <tr style="vertical-align:top;" v-for="(donnee, index) in donneescmd" :key="index">
                  <td style="width:0px;height:22px;"></td>
                  <td></td>
                  <td></td>
                  <td></td>
                ...
                <tr style="vertical-align:top;">
                  ...
                  <td class="csA2F7C04E" colspan="6"
                    ...
                    <nobr>{{ entete.TotalCmdFC }}FC</nobr>
                  </td>
                  <td></td>
                  <td></td>
                </tr>
                ...
                <tr style="vertical-align:top;">
                  ...
                  <td class="cs38AECAED" colspan="11"
                    ...
                    <nobr>Caissier : {{ entete.author }}</nobr>
                  </td>
                  <td></td>
                  <td></td>
                  <td></td>
                ...
                <tr style="vertical-align:top;">
                  ...
                  <td class="cs38AECAED" colspan="11"
                    style="width:279px;height:22px;line-height:15px;text-align:center;vertical-align:middle;">
                    <nobr>Fait le {{ entete.created_at | formatDate }}
                                  {{ entete.created_at | formatHour }}
                                </nobr>
                  </td>
                  <td></td>
                  <td></td>
    ...
    //
      ...
      created() {
        // this.showModel(this.refEnteteCmd);
      },
      computed: {
    ...
    showModel(id) {
      ...
      {
          this.editOrFetch(`${this.apiBaseURL}/fetch_detail_requisition_vente/${id}`).then(
          ({ data }) => {
            if (data) {
              _donneescmd = data.data
              this.donneescmd = _donneescmd
            }
            console.log('Teste v-for:', _donneescmd);
            _donneescmd.map((item) => {
              this.entete = item
            })
      ...
      {
          this.editOrFetch(`${this.apiBaseURL}/fetch_detail_requisition_log/${id}`).then(
          ({ data }) => {
            if (data) {
              _donneescmd = data.data
              this.donneescmd = _donneescmd
