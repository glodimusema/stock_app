...
class CreateTventeEntetePaiecommandeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tvente_entete_paiecommande', function (Blueprint $table) {
            $table->id();
            $table->string('code'); 
    ...
    {
        Schema::dropIfExists('tvente_entete_paiecommande');
    }
}
