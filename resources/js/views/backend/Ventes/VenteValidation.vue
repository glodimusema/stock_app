...
<v-layout>
                      ...
                      <v-form ref="form" lazy-validation>
                        ...
                        <v-card-text>
                          ...
                          <v-layout row wrap>
                            ...
                            <v-flex xs12 sm12 md12 lg12>
                              <div class="mr-1">
                                <v-autocomplete label="Selectionnez l'Utilisateur" prepend-inner-icon="mdi-map"
                                  ...
                                  item-value="id" dense outlined v-model="svData.user_id" chips clearable >
                                </v-autocomplete>
                              </div>
                            </v-flex>
                            ...
                            <v-flex xs12 sm12 md12 lg12>
                              <div class="mr-1">
                                <v-autocomplete label="Selectionnez le Module" prepend-inner-icon="mdi-map"
                                  :rules="[(v) => !!v || 'Ce champ est requis']" :items="moduleList" item-text="nom_unite"
                            ...
                            <v-flex xs12 sm12 md12 lg12>
                              <div class="mr-1">
                                <v-text-field  label="Code Operation" prepend-inner-icon="event" dense
    ...
    export default {
      ...
      methods: {
        ...
        // s'id','user_id','module_id','niveau','qteUnite','author'
        //   this.fetchDataList();
        // }, 300),
