                        ...
                        <v-form ref="form" lazy-validation>
                            ...
                            <v-card-text>
                                <v-text-field label="Designation" prepend-inner-icon="extension"
                                    ...
                                    v-model="svData.nom_categorie_lot"></v-text-field>
...
export default {
    ...
    data() {
        return {
            ...
            //'id','nom_categorie_lot','prix_chambre','devise','taux','author'
    ...
    methods: {
        ...
        showModal() {
            this.dialog = true;
            this.titleComponent = "Ajout Categorie Lot ";
            this.edit = false;
        ...
        testTitle() {
            if (this.edit == true) {
                this.titleComponent = "modification de " + item.nom_categorie_lot;
            } else {
        ...
        //   }, 300),
        onPageChange() {
            this.fetch_data(`${this.apiBaseURL}/fetch_gaz_categorie_lot?page=`);
        },
        ...
        validate() {
            if (this.$refs.form.validate()) {
                ...
                this.insertOrUpdate(
                    `${this.apiBaseURL}/insert_gaz_categorie_lot`,
        ...
        editData(id) {
            this.editOrFetch(`${this.apiBaseURL}/fetch_single_gaz_categorie_lot/${id}`).then(
                ({ data }) => {
        ...
        clearP(id) {
            this.confirmMsg().then(({ res }) => {
                this.delGlobal(`${this.apiBaseURL}/delete_gaz_categorie_lot/${id}`).then(
                    ({ data }) => {
